...
class NinetyNineQuestionsTest extends FunSuite with ShouldMatchers{
  ...
  test("Q8"){
    NinetyNineQuestions.compress(List('a', 'a', 'a', 'a', 'b', 'c', 'c', 'a', 'a', 'd', 'e', 'e', 'e', 'e')) should equal (List('a', 'b', 'c', 'a', 'd', 'e') )
  }
  ...
  test("Q10"){
    NinetyNineQuestions.encode(List('a', 'a', 'a', 'a', 'b', 'c', 'c', 'a', 'a', 'd', 'e', 'e', 'e', 'e')) should equal (List((4,'a'), (1,'b'), (2,'c'), (2,'a'), (1,'d'), (4,'e')))
  }
  ...
  test("Q12"){
    NinetyNineQuestions.decode(List((4, 'a'), (1, 'b'), (2, 'c'), (2, 'a'), (1, 'd'), (4, 'e'))) should equal ( List('a', 'a', 'a', 'a', 'b', 'c', 'c', 'a', 'a', 'd', 'e', 'e', 'e', 'e'))
  }
  ...
  test("Q15"){
    NinetyNineQuestions.duplicateN(3, List('a', 'b', 'c', 'c', 'd')) should equal (List('a', 'a', 'a', 'b', 'b', 'b', 'c', 'c', 'c', 'c', 'c', 'c', 'd', 'd', 'd'))
  }

  test("Q16"){
    NinetyNineQuestions.drop(3, List('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k')) should equal (List('a', 'b', 'd', 'e', 'g, 'h', 'j', 'k'))
  }

  test("Q17"){
    NinetyNineQuestions.split(3, List('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k')) should equal ((List('a', 'b', 'c),List('d', 'e', 'f', 'g, 'h', 'i', 'j', 'k')))
  }

  test("Q18"){
    NinetyNineQuestions.slice(3, 7, List('a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'i', 'j', 'k')) should equal (List('d', 'e', 'f', 'g'))
  }
